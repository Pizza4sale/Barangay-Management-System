    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active" >
        ...
        <div class="carousel-container" style="height: 10%"   >
         ...
         Apply now for your certification <br> via online!</h2>
    ...
    <section  class="contact" style="color:black" >
      <div class="container">
        <div class="section-title" data-aos="zoom-out">
          <h2>Low Income Certification</h2>
  ...
  <div class="column">
   <div style="padding-left:4px;">
     <h4>How to request online?</h4>
           <small>1. Click <a href="user/index.php">here</a> to Log in your credential or create an account if you don't have one. <br>
                  2. Secure the following requirements:
                  <br>
                    &nbsp &nbsp &nbsp - Barangay ID / Voter's ID <br>
                    &nbsp &nbsp &nbsp - Payment of ₱35.00 (Note: We only accept GCASH Payments) <br>
   ...
   <div class="column">
       <center>
          <img src="img/<?php echo "newpayment.png"; ?>" alt="" style="width:50%;" height='90' class="img-fluid"><br>
    </center>
  </div>
</div>
</form>
