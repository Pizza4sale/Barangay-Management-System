  ...
  <body>
   ...
   <?php
      ...
      if($_GET['from'] =="org"){
           ...
           $query = "SELECT distinct * FROM tbl_org where org_id ='".$_GET['id']."' ";  
              ...
              <div class="card">
                <div class="card-body" style="background-color:whitesmoke;width:100%;border-radius:12px;color:lightslategrey;">
                 <h4> - Barangay Official Details - </h4><br>
                  <div class="row mb-3">
                    <div class="col-lg-12">
                        <img src="../../img/brgy/<?php echo $row['org_pic']; ?>" width='150' alt="" class="img-fluid">
                    </div>
                </div>
                 <div class="row mb-3">
                    <div class="col-lg-12">
                         <label for="hue-demo" style="float:left">Upload New Picture</label> 
                       <input type="file" class="form-control demo" name="pictureorg" autocomplete="off" />
                    </div>
                </div>
               <div class="row mb-3">
                    <div class="col-lg-7">
                       <label for="hue-demo"style="float:left" >Official's Name</label>
                       <input type="text" class="form-control demo" placeholder="Enter name" value="<?php echo $row['org_name']; ?>" name="name" autocomplete="off" required />
                       <input type="hidden" class="form-control demo" placeholder="Enter name" value="<?php echo $_GET['id']; ?>" name="idd" autocomplete="off" required />
                    </div>
                    <div class="col-lg-5">
                      <label for="hue-demo" style="float:left">Official's Position</label> 
                      <select  class="form-control demo" name='pos'>
                        <option selected><?php echo $row['org_pos']; ?></option>
                      <?php 
                  ...
                  <div class="card-body">
                    <button type="submit" class="btn btn-primary text-white" name="upd1"><i class="fas fa-save"></i> Update Details</button>
                    <a href="updatebrgy.php" class="btn btn-danger text-white"><i class="fas fa-arrow-alt-circle-left"></i> Back</a>
                  </div>
                </div>
    ...
    if(isset($_POST['upd1'])){
      ...
      if( $filename !=""){
        ...
        if (!in_array($extension, ['jpg','JPG','png','PNG','JPEG'])) { 
          ...
          <?php  
              ...
              $sql = "UPDATE tbl_org SET org_name ='".$orgname."',org_pos='".$orgpos."',org_pic='".$filename."',`date_added`='".$dat."' WHERE org_id='".$orgid."' ";
              ...
              if (move_uploaded_file($tempname, $folder))  {
                 ...
                 <script>
                      ...
                      window.location.replace("edit_website.php?id=<?Php echo $orgid; ?>&from=org");
                  </script>
                  <?php
              }else{
         ...
         $sql = "UPDATE tbl_org SET org_name ='".$orgname."',org_pos='".$orgpos."',`date_added`='".$dat."' WHERE org_id='".$orgid."' ";
              mysqli_query($conn, $sql);
        ?>
                  <script>
      ...
      if($_GET['from'] =="faq"){
           ...
           $query = "SELECT distinct * FROM tbl_faq where id ='".$_GET['id']."'";  
           $result = mysqli_query($conn, $query);  
           while($row = mysqli_fetch_array($result)) { ?>
      <center>
        <form method="post" enctype="multipart/form-data" >
                ...
                <div class="card-body" style="background-color:whitesmoke;width:100%;border-radius:12px;color:lightslategrey;">
                 ...
                 <div class="row mb-3">
                    <div class="col-lg-12">
                        ...
                        <input type="text" class="form-control demo" placeholder="Enter question" value="<?php echo $row['question']; ?>" name="question" autocomplete="off" required />
                    </div>
                </div>
               <div class="row mb-3">
                    <div class="col-lg-12">
                       <label for="hue-demo"style="float:left" >Answer</label>
                       <textarea class="form-control demo" name="answer" rows='5' ><?php echo $row['answer']; ?></textarea>
                     ...
                     <div class="border-top">
                  <div class="card-body">
                    <button type="submit" class="btn btn-primary text-white" name="upd21"><i class="fas fa-save"></i> Update Details</button>
                    <a href="updatefaq.php" class="btn btn-danger text-white"><i class="fas fa-arrow-alt-circle-left"></i>  Back </a>
                  </div>
                </div>
    ...
    if(isset($_POST['upd21'])){
        ...
        // If upload button is clicked ...
           ...
           $faqid= $_POST['idd'];
              ...
              $sql = "UPDATE tbl_faq SET question ='".$question."',answer='".$answer."' ,`date_added`='".$dat."' WHERE id='".$faqid."' ";
              mysqli_query($conn, $sql);
                
        ?>
                  <script>
                      alert("Successfully updated!");
                      window.location.replace("edit_website.php?id=<?Php echo $faqid; ?>&from=faq");
                  </script>
                  <?php
          }
     } // end of official details edit ?>
