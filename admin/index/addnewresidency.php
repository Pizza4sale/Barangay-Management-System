                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                     New Application / Barangay Residency
                    </li>
                  </ol>
                </nav>
              </div>
...
<center>
   ...
   <?php
        ...
        <form method="post" action="saveresidency_b.php"  enctype="multipart/form-data" >
         <br>
                  ...
                  <h2  style="padding-left:-10px;font-size:20px;background-color: #0C4AF3;" class="badge rounded-pill"> &nbsp New Application |  Barangay Residency &nbsp </h2><br>
            
          <div class="row mb-3" style="padding-left : 30px;padding-right : 30px;">
                    <div class="col-lg-4">
                    <label><small class="text-muted">First Name</small></label >
                    <input type="text" name="fname" value="<?php echo $fname; ?>" class="form-control" autocomplete="off" placeholder="First Name" required>
                   </div>
                   <div class="col-lg-4">
                     <label><small class="text-muted">Middle Name</small></label >
                    <input type="text" name="mname" value="<?php echo $mname; ?>" class="form-control" placeholder="Middle Name" autocomplete="off" >
                  </div>
                  <div class="col-lg-4">
                 ...
                 <div class="row mb-3" style="padding-left : 30px;padding-right : 30px;">
                  ...
                  <div class="col-lg-4">
                    ...
                    <input type="text" name="pnum" value="<?php echo $contact; ?>" class="form-control phone-inputmask" autocomplete="off"  >
                  </div>
                  <div class="col-lg-4">
                ...
                <div class="row mb-3" style="padding-left : 30px;padding-right : 30px;">   
                   <div class="col-lg-4">
                    <label><small class="text-muted">Are you a registered voter?</small></label ><br>
                     ...
                     <option selected <?php echo $disable;  echo $voterr; ?> ><?php echo $voter; ?></option>
                     <option value="yes">Yes, I am a registered voter</option>
                     <option value="no">No, I'm not yet registered</option>
                  </select>
                  </div>  
                  <div class="col-lg-8">
                    <label><small class="text-muted">Full Address - Purok (Sitio/Purok/Zone/Building No.)</small></label >
                   <input type="text" value="<?php echo $purok; ?>" name="street" class="form-control" placeholder="Sitio/Purok/Zone/Building No." autocomplete="off" required>
                  </div>
                </div>
                 <div class="row mb-3" style="padding-left : 30px;padding-right : 30px;">   
                   <div class="col-lg-4">
                     <label><small class="text-muted">Barangay</small></label >
                    <input type="text" name="brgy" value="<?php echo $brgy; ?>" class="form-control" placeholder="Barangay" autocomplete="off" required>
                  </div>
                  <div class="col-lg-4">
                     <label><small class="text-muted">City</small></label >
                   <input type="text"  class="form-control" name="sal" value="<?php echo $city; ?>" autocomplete="off" >
                 </div>
                 <div class="col-lg-4">
                   <label><small class="text-muted">Country</small></label >
                   <input type="text" class="form-control" name="phil" value="<?php echo $country; ?>" >
                  </div>
                 </div>
                 
                <div class="row mb-1" style="padding-left : 30px;padding-right : 30px;">   
                    <div class="col-lg-4">
                    <label><small class="text-muted">-</small></label ><br>
                    <input type="hidden" name="attached" class="form-control">
                  </div>
                  </div>
      
                <div class="row mb-3" style="padding-left:  20px;">&nbsp  &nbsp 
                  <center>
                <button onclick="return confirm('Are you sure you want to process this request ?')"type="submit" style="width:30%;color:white;border-radius: 8px;" class="btn btn-info" name="finish"><i class="fas fa-save"></i> Process / Save</button>
