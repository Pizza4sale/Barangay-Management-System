...
<center><br>
   ...
   <?php 
   $style1 = "style=''";
        $sqlrt01 = "SELECT * FROM `tbl_permit` where reqnum='".$_GET['cnum']."' ";
           ...
           <h2  style="padding-left:-10px;font-size:20px;background-color: #0C4AF3;" class="badge rounded-pill"> &nbsp Barangay Business Permit - Control No.: <?php echo $_GET['cnum']; ?> &nbsp </h2>
              ...
              <div class="row mb-3" style="padding-left : 30px;padding-right : 30px;">   
                ...
                <?php if($resultQueryrt01['status']=="NEW"){ ?>
                 <button onclick="return confirm('Are you sure you want to process this request ?')" name="save" type="submit" style="width: 30%;color:white;" class="btn btn-primary"><i class="fas fa-save"></i> Process / Save</button>
