  ...
  <body>
    ...
    <div class="page-wrapper">
      ...
      <div class="container-fluid">
        <div class="tab">
          <button type="button" class="tablinks active" id='defaultOpen'><i class="fas fa-money-bill-wave"></i> Payment Record &nbsp <a href="pdf/generate_payment.php?id=0" target="_blank" class="badge btn-success" >Print</a></button>
        </div>
        <?php
