...
<center>
   ...
   <?php 
   $style1 = "style=''";
        $sqlrt01 = "SELECT * FROM `tbl_soloparent` where reqnum ='".$_GET['cnum']."' ";
        $processQueryrt01 = $conn->query($sqlrt01);
        while ($resultQueryrt01 = $processQueryrt01->fetch_assoc())
        {  

         ?> 
        <form method="post" action="savesoloparent.php"  enctype="multipart/form-data" >
        <br>
         <div class="card" >
          <h2  style="padding-left:-10px;font-size:20px;background-color: grey;" class="badge rounded-pill"> &nbsp Certificate of Solo Parent - Control No.: <?php echo $_GET['cnum']; ?> &nbsp </h2>
<center>
            ...
            <div class="card-body" style="background-color:#25304E;width:90%;border-radius:12px" >
              <div class="row mb-3 mt-1" style="padding-left : 30px;padding-right : 30px;padding-top: 1px;">
                ...
                <div class="row mb-3 mt-1" style="padding-left : 30px;padding-right : 30px;padding-top: 1px;">
                   <div class="col-lg-4">
                 <label><small class="text-muted">WORK</small></label >
                  <input type="text" class="form-control" name="work"  value="<?php echo $resultQueryrt01['work']; ?>" autocomplete="off" <?php echo $style1; ?>>
                </div>
                  <div class="col-lg-4">
                 <label><small class="text-muted">WORK ADDRESS</small></label >
                  <input type="text" class="form-control" name="workadd"  value="<?php echo $resultQueryrt01['workadd']; ?>" autocomplete="off" <?php echo $style1; ?>>
                </div>
                <div class="col-lg-4">
                 <label><small class="text-muted">NUMBER OF SUPPORTED CHILD</small></label >
                  <input type="text" class="form-control" name="child"  value="<?php echo $resultQueryrt01['child']; ?>" autocomplete="off" <?php echo $style1; ?>>
                </div>
                </div>
                ...
                <div class="row mb-3 mt-1" style="padding-left : 30px;padding-right : 30px;padding-top: 1px;">
                  <div class="col-lg-8">
                   ...
                   <a class='badge btn-warning' href="../../user/pages/file/<?php echo $file; ?>" target="_blank">View Attachment</a>
                  </div>
               ...
               <?php if($resultQueryrt01['pay_status']=="NEW"){ ?>
                <button onclick="return confirm('Are you sure you want to process this request ?')" type="submit" style="width: 20%;color:white;border-radius: 5px;" class="btn btn-primary" ><i class="fas fa-save"></i>  Process / Save</button>
                  <a href="payment_ref_edit.php?cnum=<?php echo $_GET['cnum']; ?>&oldcnum=A&from=soloparent" style="width: 20%;color:white;border-radius: 5px;" class="btn btn-danger" > <i class="fas fa-arrow-alt-circle-left"></i> Back to Home</a>
                <?php }else{?>
                    <br>
