    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          <div class="tab">
            <button class="tablinks" onclick="openCity(event, 'cd')" id='defaultOpen'><i class="fas fa-question"></i> Barangay FAQ's &nbsp <a href="addwebsite.php?from=faq" class="badge btn-success" >+</a></button>
          </div>
          <?php
