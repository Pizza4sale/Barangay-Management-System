...
<center><br>
   ...
   <?php 
   $style1 = "style=''";
        $sqlrt01 = "SELECT * FROM `tbl_complaint` where reqnum='".$_GET['cnum']."' ";
        ...
        <form action="create_report.php">
                ...
                <div class="card-body">
                   <div class="row mb-3" style="padding-left : 30px;padding-right : 30px;">
                    <div class="col-lg-4">
                    <label><small class="text-muted">Date and Time Sent</small></label >
                    ...
                    <input type="text" name="fname" class="form-control" readonly value="<?php echo $resultQueryrt01['datesent']; ?>" autocomplete="off" <?php echo $style1; ?> >
                   </div>
                </div>
                <div class="row mb-3" style="padding-left : 30px;padding-right : 30px;">
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-4">
                    ...
                    <a href="../../user/pages/file/<?php echo $resultQueryrt01['upload']; ?>" target="_blank"><?php echo $resultQueryrt01['upload']; ?></a>
                  </div>
                </div>
                <div class="row mb-3" style="padding-left : 30px;padding-right : 30px;">
                  <div class="col-lg-4">
