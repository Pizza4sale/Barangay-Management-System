...
<CENTER>
        ...
        <form method="post" action="savelowincome_2.php" ><br>
                  ...
                  <h2  style="padding-left:-10px;font-size:20px;background-color: #0C4AF3;" class="badge rounded-pill"> &nbsp New Application |  Certificate of Low Income &nbsp </h2>
                  <br>
                ...
                <div class="row mb-3 mt-1" style="padding-left : 30px;padding-right : 30px;padding-top: 1px;">
                 ...
                 <div class="row mb-3 mt-1" style="padding-left : 30px;padding-right : 30px;padding-top: 1px;">
                  ...
                  <input type="nummber" name="work"  class="form-control" required>
                  </div>
        
                      <div class="col-md-4 form-group">
                        <label for="exampleInputEmail1" style="color:gray">*Work Address</label>
                     <input type="nummber" name="workadd"  class="form-control"  required>
                      </div>
                      <div class="col-md-4 form-group">
                        <label for="exampleInputEmail1" style="color:gray">*Monthly Income</label>
                      <input type="nummber" name="monthly"  class="form-control"  maxlength="7" required>
                      </div>
                 </div>
                  <div class="row mb-3" style="padding-left : 30px;padding-right : 30px;padding-top: 1px;  ">
                   <div class="col-md-4 form-group">
                      ...
                      <input type="text" name="brgy" value='<?php echo $brgy; ?>' class="form-control" autocomplete="off" >
                      </div>
                      <div class="col-md-2 form-group">
                        <label for="exampleInputEmail1" style="color:gray">*City/Province</label>
                      <input type="text"  class="form-control" value='<?php echo $city; ?>' name="sal" autocomplete="off" >
                      </div>
                      <div class="col-md-2 form-group">
                ...
                <br>
                 <div class="row mb-3" style="padding: 30px;padding-top: 1px;">http://localhost/milawid_official/admin/index/lowincomefile.php
                  <div class="col-lg-12">
