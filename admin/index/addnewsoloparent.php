                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                     New Application / Certificate of Low Income
                    </li>
                  </ol>
                </nav>
              </div>
...
<CENTER>
        ...
        <form method="post" action="savesoloparent_2.php" ><br>
                  ...
                  <h2  style="padding-left:-10px;font-size:20px;background-color: #0C4AF3;" class="badge rounded-pill"> &nbsp New Application |  Certificate of Solo Parent &nbsp </h2>
                  <br>
                ...
                <div class="row mb-3 mt-1" style="padding-left : 30px;padding-right : 30px;padding-top: 1px;">
                  <div class="col-lg-4">
                    ...
                    <input type="tel"  class="form-control phone-inputmask" value="<?php echo $contact; ?>" name="number" autocomplete="off"> 
                      ...
                      <div class="col-md-4 form-group">
                        ...
                        <input type="date" name="bday"  class="form-control" value="<?php echo $bday; ?>" required>
                      </div>
                      <div class="col-md-4 form-group">
                 ...
                 <div class="row mb-3 mt-1" style="padding-left : 30px;padding-right : 30px;padding-top: 1px;">
                  <div class="col-lg-4">
                    <label for="exampleInputEmail1" style="color:gray">*Work</label>
                    <input type="text" class="form-control" name="work" autocomplete="off"  required> 
                  </div>
        
                      <div class="col-md-4 form-group">
                        <label for="exampleInputEmail1" style="color:gray">*Work Address</label>
                        <input type="text" class="form-control" name="workadd" autocomplete="off"  required> 
                      </div>
                      <div class="col-md-4 form-group">
                        <label for="exampleInputEmail1" style="color:gray">*Number of Supported Child</label>
                        <input type="text" class="form-control" name="child" autocomplete="off"  required> 
                      </div>
                 </div>
                  ...
                  <div class="row mb-3" style="padding-left : 30px;padding-right : 30px;padding-top: 1px;  ">
                   <div class="col-md-4 form-group">
                       ...
                       <input type="text"name="street" class="form-control" value="<?php echo $purok; ?>" placeholder="Sitio/Purok/Zone/Building No."  autocomplete="off" required>
                      </div>
                      <div class="col-md-4 form-group">
                        <label for="exampleInputEmail1" style="color:gray">*Barangay</label>
                      <input type="text" name="brgy" class="form-control" value="<?php echo $brgy; ?>" autocomplete="off" >
                      </div>
