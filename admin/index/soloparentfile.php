    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <?php  if($_SESSION["userpos"] =='ADMIN02'){  ?>
            <button class="tablinks" style="border-radius: 30px;width:100%" onclick="openCity(event, 'cd')" id="defaultOpen"> Certificate of Solo Parent
            </button>
          <?php }else{ ?>
            <button class="tablinks" style="border-radius: 30px;width:100%" onclick="openCity(event, 'ab')" id="defaultOpen">
              Certificate of Solo Parent &nbsp 
            <?php
            $sqlw1 = "SELECT count(reqnum) as num FROM tbl_soloparent where status='OLD' ";
                ...
                <div class="card-body">
                   <br>
                    ...
                    <?php  if(isset($_POST['show'])){ 
                            $sql1 = "SELECT * FROM tbl_soloparent where status='OLD' and captain='okay' and date_rel BETWEEN '".$_POST['from']."' AND '".$_POST['too']."' ORDER by date_rel ASC";
                            }else{
                             $sql1 = "SELECT * FROM tbl_soloparent where status='OLD' and captain='okay' ORDER by datereleased ASC ";
                            }
                      ?>
                      ...
                      <tr>
                          ...
                          <td>
                            <?php if( $resultQuery['captain'] =="okay" ){  ?>
                              <a target="_blank" onclick="return confirm('Are you sure you want to proceed with this request ?')" href="pdf/generatesoloparent.php?id=<?php echo $resultQuery['reqnum']; ?>" class="badge btn-success"> <img src="img/<?php echo 'immigration.png'; ?>" alt="" width="30" class="img-fluid"></a>
                              <?php } ?>
                          </td>
                        </tr>
                    <?php } ?>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="example" class="table display" style="font-size:12px;color:black" >
                      ...
                      <tbody>
                <?Php 
                     $sql1 = "SELECT * FROM tbl_soloparent where captain='wait' ";
                     $processQuery1 = $conn->query($sql1);
                     while ($resultQuery = $processQuery1->fetch_assoc())
                    { ?>
                      <tr>
                          ...
                          <td><b> Name: </b> <?php echo $resultQuery['lname'].",".$resultQuery['fname']; ?><br>
                            ...
                            <td><a target="_blank" href="pdf/generatesoloparent.php?id=<?php echo $resultQuery['reqnum']; ?>" class="badge btn-danger">View Solo Parent File</a><br>
                         ...
                         <?php } ?>
                          ...
                          <td> <a style="font-size: 13px;" onclick="return confirm('Are you sure you want to proceed with this request ?')" href='process.php?cnum=<?php echo $resultQuery['reqnum']; ?>&type=psolo&cnum2=<?php echo $resultQuery['old_ctrl']; ?>' class="badge btn-success"><i class='fa fa-check'></i> Proceed </a></td>
                        </tr>
                    <?php } ?>
                      </tbody>
                    </table>
