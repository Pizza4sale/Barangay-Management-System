...
if(isset($_POST['ok']))
{
  $rr = strtotime($_POST['timee']);
  $tim = date('h:i: A', $rr);
    $schedd = $_POST['datee']." | ".$tim;
    $queryx = mysqli_query($conn, "update `tbl_complaint` set visitsched = '".$schedd."' where com_id = '".$_POST['iddd']."'");
}
      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="tab" style="border-radius: 10px;">
            <?php  if($_SESSION["userpos"] =='ADMIN02'){  ?>
              <button class="tablinks" style="border-radius: 30px;width:100%;"onclick="openCity(event, 'cd')" id="defaultOpen">Barangay Complaints Record</a>
            </button>
            <?php }else{ ?> 
                ...
                <div class="card-body">
                   <br>
                    ...
                    <?php  if(isset($_POST['show'])){ 
                            $sql1 = "SELECT * FROM tbl_complaint where status !='NEW' and status !='DECLINE'  and date_closed BETWEEN '".$_POST['from']."' AND '".$_POST['too']."' ";
                            }else{
                   ...
                   <table  id="example" class="table display"  style="font-size:12px;color:black;" >
                      <thead>
                        <tr style="background-color:#36A3DF;">
                           ...
                           <th <?php echo $style1; ?>><b>Complaint Dates</b></th>
                ...
                <?Php 
                    ...
                    {  ?>
                      <tr>
                          ...
                          <td style="width: 30%">
                            <b> Complainant: </b> <?php echo $resultQuery['from']; ?>
                            <br> <b>Contact: </b> <?php echo $resultQuery['phoneno']; ?>
                            <br> <b> Complainee: </b> <?php echo $resultQuery['to']; ?><br>
                            <b>Evidence: </b> <a href="../../user/pages/file/<?php echo $resultQuery['upload']; ?>" target="_blank">View Attachment</a></td>
                           <td style="width: 50%" >
                            <b> Schedule: </b> <?php if($resultQuery['visitsched']==""){echo "No available schedule yet"; }else{ echo $resultQuery['visitsched']; } ?>
                           <br> <b> Date Closed: </b> <?php echo $resultQuery['date_closed']; ?>
                          ...
                          <?php }  
                            if($resultQuery['captain'] =='okay')
                                 { $ln = 'generate_complain.php'; }
                            else { $ln = 'generate_complain2.php'; } 
                           ?>
                            <br><Br ><a target="_blank" style="font-size: 13px;background-color:#3498DB" href="pdf/<?php echo $ln; ?>?id=<?php echo $resultQuery['com_ctrl']; ?>" class="badge"><i class="fas fa-folder"> </i> Report &nbsp &nbsp</a>
                          ...
                          <?php } ?>
                            ...
                            if($resultQuery['captain'] =="" ){ ?>
                            <a style="font-size: 13px;" onclick="return confirm('Are you sure you want to declare this case as CLOSED ?')" href="process.php?cnum=<?php echo $resultQuery['com_ctrl']; ?>&from=complain&type=submitt" class="badge btn-danger"><i class='fa fa-times'></i> Submit Case</a>
                          <?php } elseif($resultQuery['captain'] =="okay") { echo "CASE CLOSED"; }
                                  else{ echo "<b> <em> For Captain Signature </em> </b> " ;} } ?>
                            </td>
                        </tr>
                    <?php } ?>
                      </tbody>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                   <table  id="example" class="table display"  style="font-size:12px;color:black;" >
                      ...
                      <tbody>
                <?Php 
                     $sql1 = "SELECT * FROM tbl_complaint where captain='wait' ";
                     $processQuery1 = $conn->query($sql1);
                     while ($resultQuery = $processQuery1->fetch_assoc())
                    {  ?>
                      <tr>
                          ...
                          <td style="width: 30%">
                           ...
                           <td style="width: 50%" >
                            <b> Schedule: </b> <?php if($resultQuery['visitsched']==""){echo "No available schedule yet"; }else{ echo $resultQuery['visitsched']; } ?>
                           <br> <b> Date Closed: </b> <?php if($resultQuery['date_closed']==""){echo "N/A"; }else{ echo $resultQuery['date_closed']; }  ?>
                            ...
                            <td>
                            <?php 
                            if($resultQuery['captain'] =="wait" ){ ?>
                            <a style="font-size: 13px;" onclick="return confirm('Are you sure you want to declare this case as CLOSED ?')" href="process.php?cnum=<?php echo $resultQuery['com_ctrl']; ?>&from=complain&type=caseclose" class="badge btn-danger"><i class='fa fa-times'></i> Close Case</a>
                          <?php } ?>
                            </td>
                        </tr>
                    <?php } ?>
