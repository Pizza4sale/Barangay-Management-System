      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="tab" style="border-radius: 10px;">
             <?php  if($_SESSION["userpos"] =='ADMIN02'){  ?>
            <button class="tablinks" style="border-radius: 30px;width:100%" onclick="openCity(event, 'cd')" id="defaultOpen"> Certificate of Low Income
            </button>
          <?php } else{ ?>
             <button class="tablinks" style="border-radius: 30px;width:100%" onclick="openCity(event, 'ab')" id="defaultOpen">
              Certificate of Low Income &nbsp 
            <?php
            $sqlw1 = "SELECT count(reqnum) as num FROM tbl_lowincome where status='OLD' ";
                ...
                <div class="card-body">
                  <br>
                    ...
                    <?php  if(isset($_POST['show'])){ 
                            $sql1 = "SELECT * FROM tbl_lowincome where status='OLD' and captain='okay' and date_rel BETWEEN '".$_POST['from']."' AND '".$_POST['too']."' ORDER by date_rel ASC";
                            }else{
                             $sql1 = "SELECT * FROM tbl_lowincome where status='OLD' and captain='okay' ORDER by datereleased ASC ";
                            }
                      ?>
                    ...
                    <table id="example" class="table display" style="font-size:12px;color:black" >
                      <thead>
                       <tr style="background-color:#36A3DF;">
                           ...
                           <th <?php echo $style1; ?>><b>Contact Number</b></th>
                ...
                <?Php 
                    ...
                    { ?>
                      <tr>
                          ...
                          <td><?php echo $resultQuery['reqnum']; ?></td>
                          <td><?php echo $resultQuery['lname'].",".$resultQuery['fname']; ?></td>
                            <td><?php echo $resultQuery['address']; ?></td>
                          <td><?php echo $resultQuery['phonenumber']; ?></td>
                          <td>
                            <?php if( $resultQuery['captain'] =="okay" ){  ?>
                              <a target="_blank" href="pdf/generatelowincome.php?id=<?php echo $resultQuery['reqnum']; ?>" class="badge btn-success"> <img src="img/<?php echo 'immigration.png'; ?>" alt="" width="30" class="img-fluid"></a>
                              <?php } ?>
                          </td>
                        </tr>
                    <?php } ?>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="example" class="table display" style="font-size:12px;color:black" >
                      ...
                      <tbody>
                <?Php 
                     $sql1 = "SELECT * FROM tbl_lowincome where captain='wait' ";
                     $processQuery1 = $conn->query($sql1);
                     while ($resultQuery = $processQuery1->fetch_assoc())
                    { ?>
                      <tr>
                          <td><?php echo $resultQuery['reqnum']; ?></td>
                          <td><b> Name: </b> <?php echo $resultQuery['lname'].",".$resultQuery['fname']; ?> <br>
                              <b> Contact: </b> <?php echo $resultQuery['phonenumber']; ?><br>
                              <b> Address: </b> <?php echo $resultQuery['address']; ?></td>
                          <td><a target="_blank" href="pdf/generatelowincome.php?id=<?php echo $resultQuery['reqnum']; ?>" class="badge btn-danger">View Low Income File</a><br>
                         ...
                         <?php } ?>
                          ...
                          <td> <a style="font-size: 13px;" onclick="return confirm('Are you sure you want to proceed with this request ?')" href='process.php?cnum=<?php echo $resultQuery['reqnum']; ?>&type=plow&cnum2=<?php echo $resultQuery['old_ctrl']; ?>' class="badge btn-success"><i class='fa fa-check'></i> Proceed </a></td>
                        </tr>
                    <?php } ?>
                      </tbody>
                    </table>
