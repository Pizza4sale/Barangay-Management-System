...
<html dir="ltr" lang="en">
  ...
  <body>
            ...
            <div class="col-12 d-flex no-block align-items-center">
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="notif.php">Home</a></li>
   ...
   $style1 = "style='box-shadow: 1px 1px;'";
        ...
        {   ?> 
        <form action="create_report.php" style="color:black;background-color: grey;">
         <div class="card" style="width:100%">
                <div class="card-body">
                  <h5 class="card-title mb-0">Barangay Complaint - Control No.: <?php echo $_GET['cnum']; ?></h5><br>
                   <div class="row mb-3" style="padding-left: 20px;">
                    ...
                    <input type="date" name="fname" class="form-control" readonly value="<?php echo $resultQueryrt01['datereceived']; ?>" autocomplete="off" <?php echo $style1; ?> >
                   </div>
                </div>
                <div class="row mb-3" style="padding-left: 20px;">
                  <div class="col-lg-3">
                  ...
                  <div class="col-lg-3">
                    ...
                    <a href="file/<?php echo $resultQueryrt01['upload']; ?>" target="_blank"><?php echo $resultQueryrt01['upload']; ?></a>
                  </div>
                </div>
                 <div class="row mb-3" style="padding-left: 20px;">
                  <div class="col-lg-3">
          ...
          <?php if($_GET['from'] !="newcomp"){?>
                <div class="row mb-3" style="padding-left:  50px;">
                 <button onclick="return confirm('Are you sure you want to process this request ?')" name="report" type="submit" style="width:20%;color:white;" class="btn btn-success" name="">Create a report >></button>
                 <a href="complain_file.php" style="width:20%;color:white;" class="btn btn-danger" >Back to Notification</a>
                 </div>
             <?Php }else{ ?>
                 <div class="row mb-3" style="padding-left:  50px;">
                  <a href="process.php?from=comp&type=okay&cnum=<?php echo $resultQueryrt01['com_ctrl']; ?>" style="width:20%;color:white;" onclick="return confirm('Are you sure you want to process this request ?')" class="btn btn-primary" >Acknowledge Complaint</a> &nbsp&nbsp
                <a href="process.php?from=comp&type=notokay&cnum=<?php echo $resultQueryrt01['com_ctrl']; ?>"  style="width:20%;color:white;" onclick="return confirm('Are you sure you want to declined this request ?')" class="btn btn-danger" >Decline Complaint</a> &nbsp&nbsp
                  <a href="notif.php" style="width:20%;color:white;" class="btn btn-danger" >Back to Notification</a>
                 </div>
              <?php } ?>
          </form>  
     <?php } ?>
