    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-bs-ride="carousel">
     ...
     <div class="carousel-item active" >
         <div class="carousel-container" style="height: 30%"   >
           <h2 class="animate__animated animate__fadeInDown"> <small style="font-size:25px"> Barangay Clearance Online Application </small> <br>
             ...
             <center>
              <div class="card" style="max-width: 500px;">
                   ...
                   <p><button style="background-color: green;height:10px"></button></p>
                    <p style="font-size:50px" class="title"><?php date_default_timezone_set("Asia/Manila"); $datt = date('M d, Y h:i:s'); echo $_GET['id']."<br><small style='font-size:30px'>".$datt."</small>"; ?></p>
