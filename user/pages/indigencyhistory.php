           ...
           <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
            <?php
            $sqlrt = "SELECT * FROM `tbl_indigency` where fromuser ='".$uname."' ";
            ...
            ?>
                 ...
                 <?php
                  ...
                  <td>
                     ...
                     <!--  <a onclick="return confirm('Are you sure you want to process payment via online ?')" href="addpayment.php?id=<?php echo $resultQueryrt['reqnum']; ?>&from=newindigencyol" class="badge btn-danger">Paid Via Online</a>  -->
