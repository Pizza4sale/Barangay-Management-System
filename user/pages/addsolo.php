    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-default">
              <form method="post" action="savesolo.php"  enctype="multipart/form-data">
                ...
                <div class="bs-stepper" style="padding-right: 20px;padding-left: 20px;" >
                  <div class="bs-stepper-header" role="tablist">
                    ...
                    <div class="step" data-target="#logins-part">
                      <button type="button" class="step-trigger" role="tab" aria-controls="logins-part" id="logins-part-trigger">
                        ...
                        <span class="bs-stepper-label">Certificate of Solo Parent - New Application</span>
                      </button>
                    </div>
                    <div class="line"></div>
                  </div>
                  ...
                  <div class="bs-stepper-content">
                    ...
                    <div class="row">
                      ...
                      <input type="text" name="number" data-inputmask='"mask": "(999) 9999-9999"'  data-mask class="form-control" required>
                      </div>
                      <div class="col-md-4 form-group">
                        <label for="exampleInputEmail1" style="color:gray">*Birthday</label>
                      <input type="date" name="bday" placeholder="--" value='<?php echo $bday; ?>' class="form-control" required>
                      </div>
                      <div class="col-md-4 form-group">
                   ...
                   <!------ -->
                    <div class="row">
                      ...
                      <input type="text" name="work" placeholder="---" class="form-control" required>
                      </div>
                      <div class="col-md-4 form-group">
                        <label for="exampleInputEmail1" style="color:gray">*Work Address</label>
                      <input type="text" name="workadd" placeholder="---" class="form-control" required>
                      </div>
                      <div class="col-md-2 form-group">
                        <label for="exampleInputEmail1" style="color:gray">*Number of Supported Child</label>
                        <input type="number" name="child" placeholder="--"  maxlength="2" class="form-control" required>
                      </div>
                      <div class="col-md-2 form-group" hidden>
                        <label for="exampleInputEmail1" style="color:gray">*Upload File<br><small>(PNG/JPG/PDF)</small></label>
