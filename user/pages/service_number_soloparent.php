        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Service Request (Solo Parent)</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-lg-12 col-12">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h4><small><b>Solo Parent Request Confirmation</b><br>
                ...
                <center>
                  <!-- <p style="font-size:40px" class="title"><?php date_default_timezone_set("Asia/Manila"); $datt = date('M d, Y h:i:s'); echo $_GET['idres']; ?> -->
                    ...
                    Note:   All request made through this website will be delivered only from  <em style="font-size:20px;color:red;"> 8 a.m to 5 p.m </em> from the date of request. <br> If the request exceeds from the intended timeframe. The requested document will be delivered the <em style="font-size:20px;color:red"> next day </em> only if that day is an office hour.  </b></small>
              </div>
              <div class="icon">
