        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Certificate of Solo Parent</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
           ...
           <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
            <?php
            $sqlrt = "SELECT * FROM `tbl_soloparent` where fromuser ='".$uname."' ";
            ...
            ?>
                 <tr>
                  ...
                  <td>
                    <b> Request #: </b><br>
                    <?php if($resultQueryrt['old_ctrl'] ==""){ echo $resultQueryrt['reqnum']; }
                          else{ echo $resultQueryrt['old_ctrl']; } ?><br>
                   <b> Official # :</b><br>
                   <?php if(strpos($resultQueryrt['reqnum'],'RQT') == TRUE){ echo "No control number available";}
                          else{ echo $resultQueryrt['reqnum']; } ?>
                  </td>
                 
                    <td> 
                      <?php if($dd!="" && $captain =="okay" ){ echo "<b>Claimed was successful.</b> <br> Date Released:".$dd; }    elseif($dd=="" && $captain =="okay" ){ echo "<b>Approved by Captain.</b> <br> For Releasing of documents."; }
                  ...
                  <td> 
                     ...
                     <?php } elseif($dd=="" && $captain =="okay" ){ ?>
                        ...
                        <!-- <a onclick="return confirm('Are you sure you want to process payment via online ?')" href="addpayment.php?id=<?php echo $resultQueryrt['reqnum']; ?>&from=newsolool" class="badge btn-danger">Paid Via Online</a> 

                       <a href="cancelrequest.php?id=<?php echo $resultQueryrt['reqnum']; ?>" onclick="return confirm('Are you sure you want to cancel your request?')"  class="badge btn-warning">Cancel Request</a> -->
