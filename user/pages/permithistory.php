        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Barangay Business Permit</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            ?>
                 <tr>
                  <td> <?php echo $resultQueryrt['datetimereq']; ?></td>
                   ...
                   <b> Official # :</b><br>
                   <?php if($resultQueryrt['permit_num']=="-"){ echo "No control number available";}
                         else{ echo $resultQueryrt['permit_num']; } ?>
                  </td>
                 <td> 
                     <?php
