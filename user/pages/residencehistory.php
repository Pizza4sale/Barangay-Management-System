            ...
            ?>
                 <tr>
                  ...
                  <td>
                   ...
                   <b> Official # :</b><br>
                   <?php if($resultQueryrt['res_ctrl']=="-"){ echo "No control number available";}
                         else{ echo $resultQueryrt['res_ctrl']; } ?>
                  </td>
                  <td> 
                    <?php
