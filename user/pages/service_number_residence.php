        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Service Request (Residency)</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-lg-12 col-12">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h4>Barangay Residency<br> <?php date_default_timezone_set("Asia/Manila"); $datt = date('M d, Y h:i:s'); echo "<small style='font-size:20px'>".$datt."</small>"; ?></small></h4>
                <center>
                  <!-- <p style="font-size:50px" class="title"><?php date_default_timezone_set("Asia/Manila"); $datt = date('M d, Y h:i:s'); echo $_GET['idres']; ?><br> -->
