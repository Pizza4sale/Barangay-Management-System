        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Certificate of Low Income</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
           ...
           <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
            <?php
            $sqlrt = "SELECT * FROM `tbl_lowincome` where fromuser ='".$uname."' ";
            ...
            ?>
                ...
                <td>
                  ...
                  <td> 
                    ...
                    <!--  
                       <a onclick="return confirm('Are you sure you want to process payment via online ?')" href="addpayment.php?id=<?php echo $resultQueryrt['reqnum']; ?>&from=newlowincomeol" class="badge btn-danger">Paid Via Online</a> 

                     <a onclick="return confirm('Are you sure you want to process payment via cash ?')"  href="savepayment_cash.php?id=<?php // echo $resultQueryrt['reqnum']; ?>&from=newlowincomecash" class="badge btn-danger">Payment Via Cash</a>  -->
